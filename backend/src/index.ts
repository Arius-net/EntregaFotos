...
import { downloadFreePhotos, downloadAllFinalPhotos, downloadZip } from './controllers/downloadController';
...
app.get('/api/downloads/:gallery_id/zip', authenticateJWT, downloadZip);
