  ...
  return (
    <>
            ...
            return (
              <div 
                ...
                className={`relative aspect-square cursor-pointer rounded-2xl overflow-hidden transition-all duration-300 ${
                  isSelected ? 'ring-4 ring-blue-500 scale-[0.98]' : 'hover:scale-[1.02] hover:shadow-xl'
                }`}
              >
                <img 
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 bg-gray-800/95 backdrop-blur-xl border border-gray-700 px-8 py-4 rounded-full shadow-2xl flex items-center gap-8 z-50 transition-all w-[90%] md:w-auto max-w-2xl overflow-x-auto whitespace-nowrap">
        ...
        <button 
          className={`ml-auto md:ml-4 px-6 py-3 rounded-full font-semibold transition-all ${
            selectedCount > 0 
